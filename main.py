...
async def config():
    ...
    app.state.user_agent = "Mozilla/5.0 (X11; Linux x86_64; rv:102.0) Gecko/20100101 Firefox/102.0"
    app.state.browser = await (await app.state.pwsession.firefox.launch(headless=True)).new_context(user_agent=app.state.user_agent)
